...
namespace Datos
{
    public class DAOUsuario
    {
        ...
        public void EliminarMensajesIdioma(int idioma)
        {
            DataTable a = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
            try
            {
                NpgsqlDataAdapter dataAdapter = new NpgsqlDataAdapter("DELETE FROM traduccion.clases where idioma=" +idioma, conection);
                //dataAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;
                conection.Open();
                dataAdapter.Fill(a);
            }
        ...
        public void EliminarCompoIdioma(int idioma)
        {
            DataTable a = new DataTable();
            NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
            try
            {
                NpgsqlDataAdapter dataAdapter = new NpgsqlDataAdapter("delete from traduccion.controles where idioma_id=" + idioma, conection);
                //dataAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;
                conection.Open();
                dataAdapter.Fill(a);
            }
        ...
        public void EliminarIdioma(int idioma)
        {
            ...
            try
            {
                NpgsqlDataAdapter dataAdapter = new NpgsqlDataAdapter("delete from traduccion.idioma where id=" + idioma, conection);
                //dataAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;
                conection.Open();
                dataAdapter.Fill(a);
            }
